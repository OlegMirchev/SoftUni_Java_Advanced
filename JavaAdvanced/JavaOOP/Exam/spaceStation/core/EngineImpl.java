...
import JavaAdvanced2021.JavaOPP.Exam.spaceStation.common.Command;
...
public class EngineImpl implements Engine {
    ...
    private String addPlanet(String[] data) {
        List<String> listPlanet = Arrays.asList(data).subList(1, data.length);
        return this.controller.addPlanet(data[0], listPlanet.toArray(new String[0]));
    }
